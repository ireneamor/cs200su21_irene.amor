...
int main()
{
	...
	if(AESysInit("CS 200 - Draw Triangles") == false)
	{
		return 0;
	}
	...
	AEGameStateMgrAdd(
		...
		0,
		PlaneNormalDemo::Init,
		PlaneNormalDemo::Update,
		PlaneNormalDemo::Render,
		0,
		0);
	AEGameStateMgrAdd(
		GS_STRESS_TESTS,
	...
	RegisterGameState("Attribute Planes", GS_TRIANGLE_PLANENORM);
